...
#    [,1]                       [,2]
# [1,] "Intercept"                "0" 
# [2,] "treatment_BL_vs_D"        "0" 
# [3,] "treatment_R_vs_D"         "0" 
# [4,] "genotype_pcry_vs_WT"      "0" 
# [5,] "treatmentBL.genotypepcry" "0" 
# [6,] "treatmentR.genotypepcry"  "0" 
...
nres <- "WT_BL.vs.D"
contrast <- c("treatment_BL_vs_D")
res_l[[nres]] <- getresults_SK(contrast = contrast, nres = nres)

nres <- paste(nlist,"_BL.vs.D",sep="")
contrast <- list(c("treatment_BL_vs_D",c[5]))
res_l[[nres]] <- getresults_SK(contrast = contrast, nres = nres)

nres <- paste(nlist,"_R.vs.D",sep="")
contrast <- list(c("treatment_R_vs_D",c[6])))
res_l[[nres]] <- getresults_SK(contrast = contrast, nres = nres)


# Unterschiede zwischen WT und pCRY unter gleicher Belichtung
