...
# Belichtungseffekt für jeden Genotyp
nres <- "WT_BL.vs.D"
...
contrast <- list(c(c[2]))                # [2,] "genotype_pcry_vs_WT"
res_l[nres] <- getresults_SK(contrast = contrast, nres = nres)

# !! Fehler?!
# 31.1.24 fixed: wrong terminus for list!
nres <- paste(nlist,"BL.vs.WT_BL",sep="_")
contrast <- list(c(c[2],c[5]))           # [5,] "genotypepcry.treatmentblue"
res_l[nres] <- getresults_SK(contrast = contrast, nres = nres)

nres <- paste(nlist,"R.vs.WT_R",sep="_")
contrast <- list(c(c[2],c[6]))           # [6,] "genotypepcry.treatmentred"  
res_l[nres] <- getresults_SK(contrast = contrast, nres = nres)

# # New -> this is correct
# nres <- paste(nlist,"BL.vs.WT_BL_2",sep="_")
# contrast <- c(0,1,0,0,1,0)         # [5,] "genotypepcry.treatmentblue"
# res_l[nres] <- getresults_SK(contrast = contrast, nres = nres)
# 
# nres <- paste(nlist,"R.vs.WT_R_2",sep="_")
# contrast <- c(0,1,0,0,0,1)         # [6,] "genotypepcry.treatmentred"  
# res_l[nres] <- getresults_SK(contrast = contrast, nres = nres)
...
## Control results
```{r ctrl_results, fig.show='hold', out.width='25%'}
