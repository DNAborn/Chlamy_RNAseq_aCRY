...
p4 <- pairsplot(p,colby = 'condition', colkey = viridis(9),title = 'condition',titleLabSize = 15,trianglelabSize = 6,
                hline = 0, vline = 0,gridlines.major = FALSE, gridlines.minor = FALSE,
...
screeplot(p,
    ...
    geom_label(aes(x = horn$n + 1, y = 30,
      label = 'Horn\'s=4', vjust = -1, size = 8)) +
    geom_label(aes(x = elbow + 1, y = 50,
      label = 'Elbow=5', vjust = -1, size = 8))

bi <- biplot(p,x="PC3",y="PC1",
    lab = p$metadata$condition,
    colby = 'condition',colkey = viridis(9),
    hline = 0, vline = 0,
