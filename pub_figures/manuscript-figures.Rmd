...
ggsave(paste(fig,"_",colData(dds)$experiment[1],"_Counts_ROC40.pdf",sep=""), plot = gcounts,
width = 6,
height = 5)
}
...
# Fig 3: Volcanos
```{r volcanos, fig.height=6, fig.width=10}
...
DEGs_comb <- bind_cols(res_core[[1]][],res_core[[2]],res_core[[3]])
