...
# Fig 1: PCA
```{r 1_pca, echo=FALSE, fig.show='hold', out.width="50%", dpi=300, results='hide'}
...
# Fig 2: Counts
```{r Counts, echo=FALSE, fig.show='hold', out.width="50%", dpi=300}
...
## TPM
```{r TPM, echo=FALSE, fig.show='hold', out.width="50%", dpi=300}
...
## individual counts
```{r plot_counts2, echo=FALSE, fig.show='hold', out.width="50%", dpi=300}
ROC59 <- "Cre10.g425050"
goi <- ROC59
...
# Fig 2x: Explain data
```{r explain_data, eval=TRUE, echo=FALSE}
...
```{r volcanos1, fig.height=6, fig.width=10, echo=FALSE}
...
```{r volcanos2, fig.height=10, fig.width=10, echo=FALSE}
...
```{r volcanos3, fig.height=6, fig.width=10, echo=FALSE}
...
# Fig 4: Overlaps
## Fig 4a: Venns
```{r overlap, eval=TRUE, echo=FALSE}
fig <- "Fig4"
...
## Fig 4b: Groups
```{r groups, eval=TRUE, out.width="50%", fig.show='hold', echo=FALSE}
...
## scatter plot
```{r interaction_scatter, echo=FALSE}
# Interaction
...
# Fig. Y
```{r 3_groups, eval=FALSE, fig.show='hold', fig.width=6, fig.height=4, dpi=300, out.width="50%", echo=FALSE}
